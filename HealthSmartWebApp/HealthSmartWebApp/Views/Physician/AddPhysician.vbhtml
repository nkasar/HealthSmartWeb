...
@Code
    ViewData("Title") = "AddPhysician"
End Code

<h2>Physician Registration</h2>

@Using (Html.BeginForm()) 
    @Html.AntiForgeryToken()
    
    @<div class="form-horizontal">
        <h4>Please complete this form to register a Physician</h4>
        <hr />
        @Html.ValidationSummary(true)
         ...
         <div class="form-group">
             ...
             <div class="col-md-10">
                 @Html.TextBoxFor(Function(model) model.PhysicianFirstName)
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                @Html.TextBoxFor(Function(model) model.PhysicianLastName)
